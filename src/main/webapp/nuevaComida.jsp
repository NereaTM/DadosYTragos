...
<div class="container mt-4">
  <h1 class="mb-4">Registrar Nueva Comida</h1>

  <form action="${pageContext.request.contextPath}/comidas/crear" method="post">
    <div class="card mb-3">
      <div class="card-header bg-primary text-white">
        <h5 class="mb-0">Datos de la Comida</h5>
      </div>
      <div class="card-body">
        <div class="mb-3">
    ...
    <div class="d-flex justify-content-between">
      <a href="${pageContext.request.contextPath}/comidas" class="btn btn-secondary">
    ...
    <div class="modal fade" id="confirmarGuardarModal" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog"><div class="modal-content">
        ...
        <div class="modal-body">
          ¿Seguro que quieres crear esta comida?
        </div>
