...
<div class="container mt-4">
    <h1>Editar Perfil</h1>
    <form id="editarPerfilForm" action="${pageContext.request.contextPath}/perfil/editar" method="post">
        <div class="mb-3">
            <label for="usuario" class="form-label">Usuario*</label>
            <input type="text" id="usuario" name="usuario" class="form-control" value="<%= u.getUsuario() %>" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="apellido" name="apellido" class="form-control" value="<%= u.getApellido() %>">
        </div>
        <div class="mb-3">
            <label for="fechaNacimiento" class="form-label">Fecha de Nacimiento</label>
            <input type="date" id="fechaNacimiento" name="fechaNacimiento" class="form-control" value="<%= u.getFechaNacimiento() != null ? u.getFechaNacimiento() : "" %>">
        </div>
