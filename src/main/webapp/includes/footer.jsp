            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 mb-4">
                        <h5>Dados y Tragos</h5>
                        <p class="mb-1">Bar tematico y juegos de mesa</p>
                        <p class="mb-0">Piensa en friki</p>
                    </div>
                    <div class="col-md-4 mb-4">
                        <h5>Horario</h5>
                        <p class="mb-1">Lunes a Viernes: 17:00 - 00:00</p>
                        <p class="mb-0">Sabados: 16:00 - 02:00</p>
                         <div>
        ...
        <script>
            // cerramos notificaciones a los 5 segundos
        ...
        <%@ include file="validacionModal.jsp" %>
    </body>
</html>